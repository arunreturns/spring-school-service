...
public class TeacherController {
	...
	@RequestMapping(path="/teacher/{teacherName}", method = RequestMethod.GET)
	@ApiOperation(value = "View the list of teachers based on name", response = Teacher.class)
	public List<Teacher> getTeacherDetailsByName(@PathVariable String teacherName) {
		logger.info("Inside getTeacherDetailsByName");
		return teacherService.getTeacherDetailsByNameService(teacherName);
	}
